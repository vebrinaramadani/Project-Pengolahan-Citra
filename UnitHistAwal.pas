...
var
  FormHistAwal: TFormHistAwal;

implementation

{$R *.dfm}

procedure TFormHistAwal.MenghitungHistogram(max: Integer);
var
  i, j: Integer;
  PC: PByteArray;
begin
...
procedure TFormHistAwal.FormPaint(Sender: TObject);
var
  i, w, h: Integer;
begin
  if (Picture = nil) then
...
procedure TFormHistAwal.FormActivate(Sender: TObject);
begin
  Repaint;
end;
